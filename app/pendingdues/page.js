...
import { MoreVertical, Bell, CheckCircle, Clock, Plus } from "lucide-react";
...
export default function PendingDuesPage() {
  ...
  const filteredDues =
    filter === "All" ? duesData : duesData.filter((d) => d.status === filter);
                  ...
                  <form className="space-y-4 mt-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full mt-1 p-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-[#003f20]"
                      />
                    </div>
                    <div>
